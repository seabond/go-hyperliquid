...
func easyjson6658546bDecodeGithubComSoniricoGoHyperliquid13(in *jlexer.Lexer, out *remoteAllDexsClearinghouseStateSubscriptionPayload) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6658546bEncodeGithubComSoniricoGoHyperliquid13(out *jwriter.Writer, in remoteAllDexsClearinghouseStateSubscriptionPayload) {
	out.RawByte('{')
	first := true
	_ = first
	{
